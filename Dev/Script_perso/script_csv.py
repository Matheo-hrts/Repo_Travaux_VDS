...
class file_csv():
    ...
    def print_csv(self, path):
        ...
        with open(path, 'r') as CSV_file:
            ...
            for line in reader:
                ...
                if i != 1:
                    print(f'line {i} : name = {line[0]},' +
                          f'quantity = {line[1]}, price = {line[2]}, ' +
                          f'category = {line[3]}.')

    def merge_csv(self, directory, file_output):
        """
        Préconditions:
    ...
    def sort_csv(self, file_input):
        ...
        - Affiche les données triées et offre
        ...
        if sort_column == 'exit':
            ...
            with open(file_input, 'r', encoding='utf-8') as file:
                ...
                if (save == '' or save == 'y' or save == 'Y' or
                    ...
                    file_output = input('What will be the name ' +
                                        'of the file ? : ')
                    directory = 'sorted_csv'
                    with open(f'{directory}/{file_output}.csv', 'w',
    ...
    def what_to_do(self):
        ...
        """
        first_input = input('read [r] write [w] merge [m] sort [s] ' +
